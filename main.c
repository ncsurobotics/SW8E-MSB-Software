...
// Dropper states
#define DROPPER_RESET_STATE 1
#define DROPPER_TRIG_STATE 0
...
//Pin Definitions
#define DROP_CTRL_PORT GPIOC
#define DROP1_CTRL_PIN GPIO_PIN_6
#define DROP2_CTRL_PIN GPIO_PIN_7

#define SERVO_CTRL_PORT GPIOC
#define SERVO1_CTRL_PIN GPIO_PIN_8
#define SERVO2_CTRL_PIN GPIO_PIN_9
...
/* USER CODE BEGIN PV */
unsigned int reset_received, drop1_received, drop2_received, servo1_received, servo2_received;
...
void on_i2c_receive(int bytes){
	HAL_GPIO_WritePin(LED_GRN_PORT, LED_GRN_PIN, SET);
	led_off_time = HAL_GetTick();
	led_off_time = 0;
